...
|
    ...
    {
        $$ = new expression_descriptor($2->expr_type, "" + $2->expr_code, $2->is_null);
        delete $2;
    }
|
    expression T_NULL_COALESCING expression
    {
        if($1->expr_type != $3->expr_type)
        {
           std::stringstream ss;
        ...
        if ($1->is_null) {
            $$ = new expression_descriptor($3->expr_type, "" + $3->expr_code, $3->is_null);
        }
        else {
            $$ = new expression_descriptor($1->expr_type, "" + $1->expr_code, $1->is_null);
        }
        delete $1;
        delete $3;
    }
